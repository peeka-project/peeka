...
| [005](./005-tui-threading-and-lifecycle.md) | TUI 线程模型、主线程阻塞与关机生命周期 | SEV-1 | tui | 8 | 2026-05-07 |
| [006](./006-attach-and-agent-lifecycle.md) | 进程 Attach 就绪探测与 Agent 生命周期 | SEV-0 | core | 8 | 2026-06-07 |
...
| [009](./009-cli-commands-and-payloads.md) | CLI 命令分发、参数键与 JSONL payload 契约漂移 | SEV-1 | cli, core | 7 | 2026-06-07 |
...
| [018](./018-watch-stacking-and-orphans.md) | Watch 嵌套堆叠与孤立清理 | SEV-1 | core | 3 | 2026-06-13 |
...
- **探针堆叠与生命周期安全性**（话题 018）— 探针的卸载必须能够感知堆叠链的完整性。简单恢复原始函数会导致中间层丢失。建议所有对运行时的修改均采用基于“链”的恢复策略。
