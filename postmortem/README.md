...
| [009](./009-cli-commands-and-payloads.md) | CLI 命令分发与参数键契约不一致 | SEV-1 | cli/main.py | 4 | 2026-01-29 ~ 2026-03-18 |
| [010](./010-top-profiling.md) | Top 命令线程过滤与 TopView 并发 | SEV-1 | commands/top, tui/views/top | 4 | 2026-02-26 ~ 2026-02-26 |
...
| [016](./016-dependencies.md) | textual 版本约束与 Python 3.8 兼容 | SEV-3 | dependencies, pyproject.toml | 1 | 2026-03-20 |

## 统计

- **话题总数**：16
- **事故总次数**：73
- **按严重级别**：SEV-0: 3, SEV-1: 9, SEV-2: 3, SEV-3: 1, SEV-4: 0
- **按组件**：
...
- **按根因类别**（主要）：
  ...
  - Configuration Error: 话题 001, 002, 011
  - Type Error: 话题 007
