...
|---------|---------------|----------------|-------|
| Search classes | ✅ `sc` | ✅ `sc` | Identical |
| Search methods | ✅ `sm` | ✅ `sm` | Identical |
| Wildcard patterns | ✅ `*`, `?` | ✅ `*`, `?` | Identical |
| Detailed information | ✅ `-d` | ✅ `-d` | Identical |
| Result limit | ✅ `-n` | ✅ `--limit` | Different parameter names |
| Regular expressions | ✅ `-E` | ❌ | Arthas supports regex |
| Search by interface | ✅ `-i` | ❌ | Arthas supports interface matching |
| Search by annotation | ✅ `-a` | ❌ | Arthas supports annotation matching |
...
# Search methods
peeka-cli sm "myapp.MyClass.*"

# Detailed information
peeka-cli sc "myapp.MyClass" -d
```
...
- Supports search by interface/annotation
- Supports filtering by class loader
- Built-in Web UI
