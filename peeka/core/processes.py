...
def discover_python_processes(
    ...
    """Discover local Python processes.
...
def _discover_python_processes_with_ps(
    ...
    # /proc fallback lacks creation time, so sort by pid as a stable proxy.
...
def _python_process_from_fields(
    ...
    """Build a PythonProcess from raw fields if the process looks like Python."""
